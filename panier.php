...
$totalAvecReduction = $total - $reduction;
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right d-none d-md-block"> <a data-original-title="Save to Wishlist" title="" href="" class="btn btn-light" data-toggle="tooltip" data-abc="true"> <i class="fa fa-heart"></i></a> <a href="panier.php?del=<?=$produit["id"]?>" class="btn btn-light" data-abc="true"> supprimer</a> </td>
                                </tr>
                                </tbody>
                                 <?php endforeach ;} ?> 
            ...
            <aside class="col-lg-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr> <a href="#" class="btn btn-out btn-primary btn-square btn-main" data-abc="true"> Achat </a> <a href="shop.php" class="btn btn-out btn-success btn-square btn-main mt-2" data-abc="true">Continuer Shopping</a>
                    </div>
                </div>
            </aside>
        </div>
